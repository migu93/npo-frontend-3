    ...
    return (
        <Container>
            ...
            <Typography mt={3} align={'justify'}>
                Система менеджмента качества инженерных изысканий сертифицирована по ГOCT ISO 9001-2011 (ISO 9001:2008). Штат предприятия укомплектован квалифицированными специалистами, обученными и аттестованными в соответствии с требованиями законодательства РФ, Ростехнадзора России и других надзорных органов. Компания придает большое значение и уделяет много внимания обучению и повышению квалификации сотрудников. При производстве работ нами используется только современное оборудование и программное обеспечение, что способствует оказанию качественных услуг в сфере маркшейдерии и геодезии.
            </Typography>
